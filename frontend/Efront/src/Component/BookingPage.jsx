...
const location = useLocation();
    const {  durationDays, durationNights, endDate, startDate, tourName, tourId, subcategoryMaster } = location.state || {}
    // price,
    ...
    const handleChange = (e) => {
        ...
        if (name === "passengerType") {
            ...
            const price = basePrices[value] || 0;
            updatedData.price = (price * (1 + GST_RATE)).toFixed(2);
        }
    ...
    const handleAddPassenger = () => {
        ...
        setFormData({ firstName: "", lastName: "", dob: "", mobile: "", email: "", passengerType: "Extra Person", price: "" });
    };
    ...
    const confirmBooking = () => {
        console.log("Navigating with:", { durationDays, durationNights, endDate, startDate, tourName });
        navigate('/bookingsummary', {
            state: { durationDays, durationNights, endDate, startDate, tourName }
        });
    };
    ...
    return (<div>       
        ...
        <Card className="mb-4 p-3 shadow-sm mt-4 p-4 border rounded bg-light">
                <Card.Body>
                    ...
                    <Card.Text>
                        Days: {durationDays} & Nights:{durationNights}  | Start Date: {startDate}- End Date: {endDate}
                    </Card.Text>
                </Card.Body>
            </Card>
